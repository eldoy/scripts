...
alias admin_server="admin && puma -p 3001"
alias admin_server_production="admin && puma -p 3001 -e production"
alias site_server="site && puma -p 3000"
alias site_test_server="site && puma -p 3010 -e test"
alias site3_server="site3 && puma -p 3000"
